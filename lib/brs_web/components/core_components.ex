defmodule BrsWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BrsWeb.Gettext
          ...
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              phx-click-away={JS.exec("data-cancel", to: "##{@id}")}
               class="relative hidden transition bg-white shadow-lg shadow-zinc-700/10 ring-zinc-700/10 rounded-2xl p-6 ring-1"
            >
              <div class="absolute top-3 right-7">
                <button
                  phx-click={JS.exec("data-cancel", to: "##{@id}")}
                  type="button"
                  class="flex-none p-1 -m-3 opacity-20 hover:opacity-50"
  ...
  attr :options, :list, doc: "the options to pass to Phoenix.HTML.Forms.Options_for_select/2"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BrsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BrsWeb.Gettext, "errors", msg, opts)
    end
  end
