defmodule BrsWeb.HirePurchaseLive.Show do
    ...
    %{
      tabs: [
        %{
          ...
          mod: BrsWeb.HirePurchaseLive.ApplicationHistoryComponent
        },
        %{
          id: 2,
          title: "Hire purchase licence",
          mod: BrsWeb.HirePurchaseLive.HirePurchaseLicenceComponent
        }
      ],
      active_tab: 1,
      mobile_active_tab: 1
