defmodule BrsWeb.Forms.Plc.FormComponent do
  ...
  defp tab_init() do
    [
      %{id: 1, title: "Proposed Names", mod: BrsWeb.Forms.ProposedNamesComponent},
      %{
        id: 2,
        title: "Articles of Association",
        mod: BrsWeb.Forms.ArticlesOfAssociationComponent
      },
      %{id: 3, title: "Registered Office Address", mod: BrsWeb.Forms.OfficeAddressComponent},
      %{id: 4, title: "Share Information", mod: BrsWeb.Forms.ShareInfoComponent},
      %{id: 5, title: "Ownership Details", mod: BrsWeb.Forms.OwnershipDetailsComponent},
      %{id: 6, title: "Application Documents", mod: BrsWeb.Forms.DocumentsComponent}
    ]
  end
  ...
  def handle_event("prev-step", _params, socket) do
    ...
    send(self(), {:prev_step, current_step})
