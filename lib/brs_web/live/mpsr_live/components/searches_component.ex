defmodule BrsWeb.MpsrLive.SearchesComponent do
        ...
        <div class="sm:overflow-auto lg:overflow-visible">
          ...
          <div class="divide-y divide-gray-300">
            <div x-data="{openCard: false}" class="block sm:hidden mx-auto w-full bg-white p-3">
              ...
              >
                <div>
                  <p class="text-base font-medium text-gray-900">Application No.</p>
                  <p class="text-sm font-medium text-gray-700">IN-43456</p>
                </div>
                <span
              ...
              >
                <div class="border-t mt-4 pt-4 grid grid-cols-2 gap-4">
                  <div class="col-span-2">
                    ...
                    <p class="text-sm font-medium">IN-43456</p>
                  </div>
                  <div class="col-span-1">
                    <p class="text-xs text-gray-600">Creditor</p>
                    <div>
                      <p class="text-sm font-medium text-gray-900">
                        Rispa Kwamboka
                      </p>
