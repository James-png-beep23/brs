defmodule BrsWeb.BusinessRegisterLive.Components.AuthorisedPersons do
  ...
  def render(assigns) do
    ...
    <div class="mt-4 space-y-6">
      <div class="mb-4 pb-2 border-b">
        <h3 class="text-lg sm:text-2xl leading-6 font-medium text-primary-500 mb-1">
          Manage Other Company
        </h3>
        <p class="text-sm text-gray-500">
          These are the businesseses you are managing as an authorised person
        </p>
      </div>
