defmodule BrsWeb.StaffLive.InboxTaskComponent do
  use BrsWeb, :live_component

  def mount(socket) do
    {:ok, stream(socket, :tasks, sample_list())}
  end
          ...
          <div class="sm:overflow-auto lg:overflow-visible">
            ...
            <div class="hidden w-full align-middle sm:block">
              <div class="pb-4 shadow sm:overflow-x-auto ring-1 ring-black ring-opacity-5 sm:pb-0 rounded-lg divide-y divide-gray-200">
                ...
                <.live_component
                  module={BrsWeb.PaginationComponent}
                  id="pagination"
                  page={@page}
                  total_pages={@total_pages}
                  page_size={@page_size}
                  total_entries={@total_entries}
                  on_change_page={fn page -> send_update(@myself, page: page) end}
                />
              </div>
            </div>
            <!-- Mobile table -->
              ...
              <div x-data="{openCard: false}" class="mx-auto w-full p-3">
                ...
                >
                  <div>
                    ...
                    <p class="text-sm font-medium text-gray-700">LPR-12320</p>
                ...
                >
                  <div class="border-t mt-4 pt-4 grid grid-cols-1 gap-3">
                    <div class="col-span-1">
                      ...
                      <p class="text-sm font-normal text-gray-900">LPR-12320</p>
  ...
  def update(%{page: %{page: page}} = assigns, socket) do
    entries = %{
      page_size: 5,
      total_pages: 3,
      page: page,
  ...
  defp sample_list() do
    [
      %{
        id: 1,
        task_name: "Limited Partnership Registration",
        status: "Verification",
        submitted_by: "Joe Doe",
        submission_time: "",
        description: ""
      },
      %{
        id: 2,
        task_name: "Business Name Registration",
        status: "Complete",
        submitted_by: "Joe Doe",
        submission_time: "",
        description: ""
